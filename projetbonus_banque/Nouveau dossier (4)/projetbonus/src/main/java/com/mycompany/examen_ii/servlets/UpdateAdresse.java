 ...
 * @author Alexandre
 */
@WebServlet(name = "UpdateAdresse", urlPatterns = {"/UpdateAdresse"})
public class UpdateAdresse extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet UpdateAdresse</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet UpdateAdresse at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String new_adresse = request.getParameter("new_data_adresse");
        ...
        try {
            userDAO.UpdateAdresse(username, new_adresse);
            request.setAttribute("erreurAdresse", "false");
        } catch (SQLException ex) {
            Logger.getLogger(UpdateInfo.class.getName()).log(Level.SEVERE, null, ex);
            request.setAttribute("erreurAdresse", "true");
        } finally {
