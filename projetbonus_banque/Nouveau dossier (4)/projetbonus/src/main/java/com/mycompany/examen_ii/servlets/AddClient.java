...
public class AddClient extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        double Idliste=Double.parseDouble(liste);
        ...
        if (passwordConfirme.equals(password)) {
            ...
            try {          
                userDao.CreateUser(name, prenom, email, password, carte, montantcompte, niveau, adresseDomicile, primeBanque, fraisTransfert, fraisRetrait,Idliste);
